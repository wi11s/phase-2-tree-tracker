  ...
  return (
    <div className="App">
      ...
      <Routes>
        ...
        <Route path="addtree" element={<AddTree handleSubmit={handleSubmit} useCustomLocation={useCustomLocation} encodeImageFileAsURL={encodeImageFileAsURL} pos={pos} handleNameChange={handleNameChange} setUseCustomLocation={setUseCustomLocation} handleLatChange={handleLatChange} handleLngChange={handleLngChange}/>}/>
